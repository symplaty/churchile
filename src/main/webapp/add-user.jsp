...
<body>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="sub-menu active">
                        ...
                        <ul class="sub">
                            ...
                            <li><a class="active" href="add-user.jsp">添加用户</a></li>
                        </ul>
                    </li>
                </ul>
                <!-- sidebar menu end-->
	                    ...
	                    <div class="col-lg-12">
	                       <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class="form">
                                    <form class="form-validate form-horizontal" id="add-user">
                                        <div class="form-group ">
                                            <label for="name" class="control-label col-lg-2">用户名  <span class="required">*</span></label>
                                            <div class="col-lg-10">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-lg-10">
                                                <input class="form-control" id="password" name="password" minlength="5" maxlength="16" type="text" required />
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <label for="id-card" class="control-label col-lg-2">身份证号  <span class="required">*</span></label>
                                            <div class="col-lg-10">
                                                <input class="form-control" id="id-card" name="id-card" minlength="18" maxlength="18" type="text" required />
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <label for="type" class="control-label col-lg-2">用户类型  <span class="required">*</span></label>
                                            <div class="col-lg-10">
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-offset-2 col-lg-10">
                                                <button class="btn btn-primary" type="button" id="confirm">创建用户</button>
    ...
    $(document).ready(function() {
        ...
        $("#confirm").click(function() {
        	$.ajax({
    			url: Constants.serverPath + "user/adduser.do",
                data: {
                 	"name" : $("#name").val(),
                 	"idCard" : $("#id-card").val(),
                 	"phone" : $("#phone").val(),
